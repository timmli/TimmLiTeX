...
,#+BEGIN_EXPORT latex
\bibliographystyle{templates/jlm/jlm}
...
\titlelogo{%
  ...
  \includegraphics[width=.45\paperwidth, keepaspectratio=true]{graphics/MNF-logo.pdf}\newline
...
#+BEGIN_SRC latex
[compress,xcolor=table,dvipsnames,10pt] % other options: handout,t
#+END_SRC
