...
#+NAME: biblatex-beamer-settings-file
#+BEGIN_SRC latex :noweb yes :tangle packages/biblatex-beamer-settings.tex
...
#+NAME: biblatex-tikzposter-settings-file
#+BEGIN_SRC latex :noweb yes :tangle packages/biblatex-tikzposter-settings.tex
