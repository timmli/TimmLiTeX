...
#+NAME: text-settings
#+BEGIN_SRC latex :noweb yes :tangle templates/text-template/text-settings.tex :var nw-mycitestylepath="text-template/muss" nw-mystylepath="text-template/muss" nw-avmpath="text-template/packages/langsci-avm"
<<pdflatex-settings>>
