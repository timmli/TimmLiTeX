...
#+BEGIN_SRC latex  :noweb yes :tangle TEMPLATE-abstract.tex
...
#+BEGIN_SRC latex  :noweb yes :tangle TEMPLATE-article.tex
...
#+BEGIN_SRC org :noweb yes :tangle TEMPLATE-beamer.org
<<beamer-template-org>>
#+END_SRC
...
#+BEGIN_SRC latex  :noweb yes :tangle TEMPLATE-beamer.tex
<<beamer-template-tex>>
#+END_SRC
...
# #+BEGIN_SRC latex  :noweb yes :tangle TEMPLATE-book.tex
# <<book-template-tex>>
# #+END_SRC
...
#+BEGIN_SRC org :noweb yes :tangle TEMPLATE-langsci-paper.org
