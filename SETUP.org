...
\input{beamer-template/examples/README.tex}
  
\end{frame}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\input{beamer-template/examples/beamer-examples.tex}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% 
...
\input{beamer-template/myMacros}   % the content of myMacros.tex goes here
...
\usepackage{beamer-template/themes/beamerthemeLustnau} % \usetheme{Lustnau}  
% \usepackage{beamer-template/themes/beamerthemeTuebingen} % \usetheme{Tuebingen}
\input{beamer-template/themes/beamerlogosTuebingen.tex}

% \usepackage{beamer-template/themes/beamerthemeDuesseldorf} % \usetheme{Duesseldorf}
% \input{beamer-template/themes/beamerlogosDuesseldorf.tex}
#+END_SRC
...
#+BEGIN_SRC latex :tangle templates/beamer-template/myMacros.tex
<<myMacros.tex>>
#+END_SRC
