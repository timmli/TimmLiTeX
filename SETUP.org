...
#+NAME: anyclass-abstract-template
#+BEGIN_SRC latex :noweb yes :tangle templates/anyclass-abstract-template.tex
\documentclass[
class=abstract,
options={
<<abstract-options>>
...
#+NAME: anyclass-article-template
#+BEGIN_SRC latex :noweb yes :tangle templates/anyclass-article-template.tex
\documentclass[
class=scrarticle,
options={
<<article-options>>
...
#+NAME: anyclass-beamer-template
#+BEGIN_SRC latex :noweb yes :tangle templates/anyclass-beamer-template.tex
\documentclass[
class=beamer,
options={
<<beamer-options>>
...
#+NAME: anyclass-book-template
#+BEGIN_SRC latex :noweb yes :tangle templates/anyclass-book-template.tex
\documentclass[
class=book,
options={
<<book-options>>
