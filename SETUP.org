...
#+BEGIN_SRC org :noweb yes :tangle my-templates/abstract-template.org
...
#+BEGIN_SRC latex :noweb yes :tangle my-templates/abstract-template.tex
\documentclass[
<<abstract-options>>
]{article}
...
#+BEGIN_SRC org :noweb yes :tangle my-templates/article-template.org
,#+TITLE: Title of paper
...
#+BEGIN_SRC latex :noweb yes :tangle my-templates/article-template.tex
\documentclass[
<<article-options>>
]{scrartcl}
...
#+BEGIN_SRC org :noweb yes :tangle my-templates/beamer-template.org
,#+TITLE: Beamer slides
,#+AUTHOR: John Doe
...
#+BEGIN_SRC latex :noweb yes :tangle my-templates/beamer-template.tex
% -*- coding: utf-8 -*-
...
#+BEGIN_SRC latex :noweb yes :tangle my-templates/book-template.tex
\documentclass[
<<book-options>>
]{scrbook}
...
#+BEGIN_SRC latex :noweb yes :tangle my-templates/abschlussarbeit-template.tex
\documentclass[
  11pt,
  bibliography=totoc,
  numbers=noenddot,
...
\input{template-files/abschlussarbeit-examples}
...
#+BEGIN_SRC latex :noweb yes :tangle my-templates/hausarbeit-template.tex
\documentclass[
  11pt,
  twoside,
  ]{scrartcl}
...
#+BEGIN_SRC latex :noweb yes :tangle my-templates/poster-template.tex
\documentclass[
...
\input{template-files/poster-settings}
...
\titlegraphic{\hspace*{1cm}\raisebox{0ex}{\includegraphics[width=5cm]{template-files/graphics/sfb-logo-quer.pdf}}\hspace{36cm}\raisebox{0ex}{\includegraphics[width=10cm]{template-files/graphics/hhu-logo-hres.pdf}}} 
...
\input{template-files/poster-style}
...
\input{template-files/poster-examples}
...
#+BEGIN_SRC latex :noweb yes :tangle my-templates/standalone-template.tex
\documentclass[
	%pstricks=true
	,crop=true
	,varwidth=\maxdimen
...
\usepackage{template-files/packages/langsci-avm}
<<langsci-avm-settings>>

% \usepackage[inference]{semantic} % for CCG 
% \usepackage{template-files/packages/ccg}
...
#+BEGIN_SRC latex :noweb yes :tangle my-templates/beamerthemeTuebingen.sty
\mode<presentation>
...
#+BEGIN_SRC latex :noweb yes :tangle my-templates/beamercolorthemeTuebingen.sty
\mode<presentation>
...
#+BEGIN_SRC latex :noweb yes :tangle my-templates/beamerinnerthemeTuebingen.sty
\mode<presentation>
...
#+BEGIN_SRC latex :noweb yes :tangle my-templates/beamerouterthemeTuebingen.sty
\mode<presentation>
...
#+BEGIN_SRC latex :noweb yes :tangle my-templates/beamerlogosTuebingen.tex
\titlelogo{%
  \includegraphics[width=3.967cm, keepaspectratio=true]{template-files/graphics/UT-logo.pdf}
  \hskip0.4cm 
  %% Trajan
  \begin{minipage}[t]{0.5\textwidth}
  \vskip-0.95cm
  \includegraphics[width=5.75cm, keepaspectratio=true]{template-files/graphics/UT-MNF-FBI-logo.pdf}
  \end{minipage}%
}

%% Old version with relative measures
% \titlelogo{%
% \includegraphics[width=.31\paperwidth, keepaspectratio=true]{template-files/graphics/UT-logo.pdf}
% \hskip0.4cm 
%   %% Trajan
% \begin{minipage}[t]{0.5\textwidth}
% \vskip-0.104\paperheight
% \includegraphics[width=.45\paperwidth, keepaspectratio=true]{template-files/graphics/UT-MNF-FBI-logo.pdf}
% \end{minipage}%
%   %% Trajan + Arial
%   % \begin{minipage}[t]{0.5\textwidth}
%   % \setlength{\baselineskip}{11pt}
%   % \vskip-0.108\paperheight
%   % \includegraphics[width=.45\paperwidth, keepaspectratio=true]{template-files/graphics/UT-MNF-logo.pdf}\newline
%   % \upshape\sffamily\color{UTred}\fontsize{7}{10}\selectfont\textbf{Fachbereich Informatik}
%   % \end{minipage}%
% }

\headlinelogo{%
  \includegraphics[width=2.52cm, keepaspectratio=true]{template-files/graphics/UT-logo.pdf}
}      
...
#+BEGIN_SRC latex :noweb yes :tangle my-templates/beamerthemeLustnau.sty
\mode<presentation>
...
#+BEGIN_SRC latex :noweb yes :tangle my-templates/beamerthemeDuesseldorf.sty
\mode<presentation>
...
#+BEGIN_SRC latex :noweb yes :tangle my-templates/beamerlogosDuesseldorf.tex
\titlegraphic{%
...
#+BEGIN_SRC latex :noweb yes :tangle my-templates/beamerthemeBielefeld.sty
\mode<presentation>
...
#+BEGIN_SRC latex :noweb yes :tangle my-templates/beamercolorthemeBielefeld.sty
\mode<presentation>
...
#+BEGIN_SRC latex :noweb yes :tangle my-templates/beamerinnerthemeBielefeld.sty
\mode<presentation>
...
#+BEGIN_SRC latex :noweb yes :tangle my-templates/beamerouterthemeBielefeld.sty
\mode<presentation>
...
#+BEGIN_SRC latex :noweb yes :tangle my-templates/beamerlogosBielefeld.tex
\titlelogo{%
  \includegraphics[width=3.967cm, keepaspectratio=true]{template-files/graphics/UB-LiLi-logo.pdf}
}
...
\headlinelogo{%
  \includegraphics[width=2.52cm, keepaspectratio=true]{template-files/graphics/UB-LiLi-logo.pdf}
}      
...
#+BEGIN_SRC latex :noweb yes :tangle my-templates/template-files/beamer-settings.tex
<<pdflatex-settings>>
...
%% BibLaTeX
\newcommand{\mycitestyle}{template-files/muss}
\newcommand{\mybibstyle}{template-files/muss}
<<biblatex-settings>>
...
#+NAME: text-settings
#+BEGIN_SRC latex :noweb yes :tangle my-templates/template-files/text-settings.tex
<<pdflatex-settings>>
...
#+BEGIN_SRC latex :noweb yes :tangle my-templates/template-files/poster-settings.tex
%%%%%%%%%%%%%%%%%%%%%%
%   FONT             % 
%%%%%%%%%%%%%%%%%%%%%%
...
\usepackage{linguex,template-files/packages/langsci-avm} 
\usepackage{amsmath,amssymb,amsfonts,marvosym}
\usepackage{ulem}			% to cross out text
\normalem
...
#+NAME: poster-style
#+BEGIN_SRC latex :noweb yes :tangle my-templates/template-files/poster-style.tex
...
#+BEGIN_SRC latex :noweb yes :tangle my-templates/template-files/scrarticle-settings.tex
\usepackage{datetime}
\usepackage{ifdraft}
...
#+BEGIN_SRC latex :noweb yes :tangle my-templates/template-files/myMacros.tex
<<myMacros.tex>>
#+END_SRC
...
#+BEGIN_SRC latex :noweb yes :tangle my-templates/template-files/abschlussarbeit-examples.tex
...
#+BEGIN_SRC latex :noweb yes :tangle my-templates/template-files/hausarbeit-examples.tex
...
#+BEGIN_SRC latex :noweb yes :tangle my-templates/template-files/abstract-examples.tex
...
#+BEGIN_SRC latex :noweb yes :tangle my-templates/template-files/article-examples.tex
...
#+NAME: book-examples
#+BEGIN_SRC latex :noweb yes :tangle my-templates/template-files/book-examples.tex
...
#+BEGIN_SRC latex :noweb yes :tangle my-templates/template-files/beamer-examples.tex
\begin{frame}
...
#+BEGIN_SRC latex :noweb yes :tangle my-templates/template-files/poster-examples.tex
...
\input{template-files/pdflatex_setup.tex}
\input{template-files/tikz_setup.tex}
\input{template-files/forest_setup.tex}
\input{template-files/avm_setup.tex}
...
#+NAME: beamer-latexmk
#+BEGIN_SRC shell :noweb yes :tangle my-templates/latexmkrc 
