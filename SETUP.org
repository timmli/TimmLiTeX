...
<<myMacros-input>>   % the content of myMacros.tex goes here
...
#+BEGIN_SRC latex :noweb yes :tangle template-files/beamerthemeDuesseldorf.sty
\mode<presentation>
...
#+BEGIN_SRC latex :noweb yes :tangle template-files/beamerlogosDuesseldorf.tex
\titlegraphic{%
...
#+BEGIN_SRC latex :noweb yes :tangle template-files/beamerthemeBielefeld.sty
\mode<presentation>
...
#+BEGIN_SRC latex :noweb yes :tangle template-files/beamercolorthemeBielefeld.sty
\mode<presentation>
...
#+BEGIN_SRC latex :noweb yes :tangle template-files/beamerinnerthemeBielefeld.sty
\mode<presentation>
...
#+BEGIN_SRC latex :noweb yes :tangle template-files/beamerouterthemeBielefeld.sty
\mode<presentation>
...
#+BEGIN_SRC latex :noweb yes :tangle template-files/beamer-settings.tex
<<pdflatex-settings>>
...
#+NAME: text-settings
#+BEGIN_SRC latex :noweb yes :tangle template-files/text-settings.tex
<<pdflatex-settings>>
...
#+BEGIN_SRC latex :noweb yes :tangle template-files/poster-settings.tex
%%%%%%%%%%%%%%%%%%%%%%
%   FONT             % 
%%%%%%%%%%%%%%%%%%%%%%
...
#+NAME: poster-style
#+BEGIN_SRC latex :noweb yes :tangle template-files/poster-style.tex
...
#+BEGIN_SRC latex :noweb yes :tangle template-files/scrarticle-settings.tex
\usepackage{datetime}
\usepackage{ifdraft}
...
#+BEGIN_SRC latex :noweb yes :tangle template-files/myMacros.tex
<<myMacros.tex>>
#+END_SRC
...
#+BEGIN_SRC latex :noweb yes :tangle template-files/abschlussarbeit-examples.tex
...
#+BEGIN_SRC latex :noweb yes :tangle template-files/hausarbeit-examples.tex
...
#+BEGIN_SRC latex :noweb yes :tangle template-files/abstract-examples.tex
...
#+BEGIN_SRC latex :noweb yes :tangle template-files/article-examples.tex
...
#+NAME: book-examples
#+BEGIN_SRC latex :noweb yes :tangle template-files/book-examples.tex
...
#+BEGIN_SRC latex :noweb yes :tangle template-files/beamer-examples.tex
\begin{frame}
...
#+BEGIN_SRC latex :noweb yes :tangle text-templates/references.bib
<<example-references.bib>>
#+END_SRC

#+BEGIN_SRC latex :noweb yes :tangle slides-templates/references.bib
<<example-references.bib>>
#+END_SRC

#+BEGIN_SRC latex :noweb yes :tangle poster-templates/references.bib
<<example-references.bib>>
#+END_SRC

#+BEGIN_SRC latex :noweb yes :tangle standalone-templates/references.bib
<<example-references.bib>>
#+END_SRC
...
#+BEGIN_SRC latex :noweb yes :tangle template-files/poster-examples.tex
